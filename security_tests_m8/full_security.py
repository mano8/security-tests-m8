"""Full reusable live security pytest suite."""
...
class TestConfiguredProtectedEndpoints(ConfiguredProtectedEndpointsSuite):
    pass


class TestConfiguredServiceInfoDisclosure(ConfiguredServiceInfoDisclosureSuite):
    pass
